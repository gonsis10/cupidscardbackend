...
def setup_background():
    ...
    title_audio_clip = mp.AudioFileClip("audio/greeting.mp3")
    content_audio_clip = mp.AudioFileClip("audio/content.mp3")
    mixed_audio_clip = mp.concatenate_audioclips([title_audio_clip, content_audio_clip])
